...
<section class="hero">
    <div class="hero-showcase text-center bold">
        ...
        <h4 class="italic semi-bold">
            There is no need to make the same mistake I made.
        </h4>
    ...
    <div class="hero-text white text-center">
        ...
        <p class="light-grey">
            ...
            calculating my cost of living, choosing an apartment. 
            That's why I wrote this e-book, to tell you how I did it. No bullshit,
            no stress.
        </p>
